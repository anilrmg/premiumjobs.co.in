<?php require_once("include_about/header.php"); ?>
                    ...
                    <div class="jp_contact_form_box">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="jp_contact_inputs_wrapper">
                                <i class="fa fa-user"></i><input type="text" placeholder="Name *" id="fname">
                               <p id="error-fname" style="color: red;"></p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="jp_contact_inputs_wrapper jp_contact_inputs2_wrapper">
                                <i class="fa fa-user"></i><input type="text" placeholder="Surname *" id="fsurname">
                                <p id="error-fsurname" style="color: red;"></p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="jp_contact_inputs_wrapper jp_contact_inputs2_wrapper">
                                <i class="fa fa-volume-control-phone" aria-hidden="true"></i><input type="text" placeholder="Phone No. *" id="phone">
                                <p id="error-phone" style="color: red;"></p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="jp_contact_inputs_wrapper jp_contact_inputs2_wrapper">
                                <i class="fa fa-envelope"></i><input type="text" placeholder="Email *" id="e-mail">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="jp_contact_form_btn_wrapper">
                                    ...
                                    <button class="#" type="button" id="btn_submit">Submit Now</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="jp_contact_right_box_wrapper">
                        ...
                        <div class="jp_form_add_wrapper gc_map_add_wrapper1">
                            ...
                            <div class="gc_map_location_icon_cont_wrapper">
                                <h3> Unit No.7, 2nd Floor, Seema Sadan, Manchhu Bhai Road, Malad East, Mumbai - 400097, Maharashtra, India.</h3>
                            </div>
                        </div>
                        ...
                        <div class="jp_form_add_wrapper gc_map_add_wrapper3">
                            ...
                            <div class="gc_map_location_icon_cont_wrapper gc_map_location_icon_cont_wrapper4">
                                <h3> <a href="#"> Info@Digitalsolutionmedia.Com</a></h3>
                            </div>
                        </div>
    ...
    <div class="contact-map">
        <div class="container">
            <div class="row">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3768.1272570260758!2d72.84790096421455!3d19.189643353378674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1601535136611!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0; width: 100%;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
        </div>
