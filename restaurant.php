                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img">
                                                                <a href="artgraphic.php"><img src="images/secton-img/food1.png" alt="post_img" /></a>
                                                            </div>
                                                            
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Waiter or Waitress</h4>
                                                                <p>Soho House & Co</p>
                                                                <ul>
                                            ...
                                            <div class="jp_job_post_main_wrapper_cont jp_job_post_grid_main_wrapper_cont">
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img">
                                                                <a href="artgraphic.php"><img src="images/secton-img/food2.png" alt="post_img" /></a>
                                                            </div>
                                                            
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>F & B Service – Steward & Stewardess</h4>
                                                                <p>Radisson Blu Mumbai International Airport</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>IKEA Food Team Leader - Restaurant & Cafe For Customer Meeting Point</h4>
                                                                <p>IKEA</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>Sr. Faculty/ Faculty- Food & Beverage Service Operations & Management</h4>
                                                                <p>Kohinoor College Of Hotel & Tourism Management Studies, Mumbai</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>Kitchen Staff - Kitchen Chef - Cook</h4>
