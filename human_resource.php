                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img">
                                                                <a href="artgraphic.php"><img src="images/secton-img/hr1.png" alt="post_img"/></a>
                                                            </div>
                                                            <div class="jp_job_post_right_cont">
                                                              <h4>Human Resource Executive (1 - 3 Yrs Exp.)</h4>
                                                                <p>IIBMS</p>
                                                                <ul>
                                            ...
                                            <div class="jp_job_post_main_wrapper_cont jp_job_post_grid_main_wrapper_cont">
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img">
                                                                <a href="artgraphic.php"><img src="images/secton-img/hr2.png" alt="post_img" /></a>
                                                            </div>
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Human Resources (HR) Jobs in Mumbai</h4>
                                                                <p>Dr. Lal Path Labs Limited.</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                 <h4>SENIOR EXECUTIVE HR (2-8 yrs)</h4>
                                                                <p>Nirmal Lifestyle Ltd</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>Human Resources (HR) Jobs in Mumbai</h4>
                                                                <p>Mahindra Logistics Limited</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Senior Manager - Human Resource - ISIP - Pharma (12-14 yrs)</h4>
                                                                <p>Armour Corporate Services</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                 <h4>Hr Recruiter For Biker Delivery</h4>
                                                                <p>Shadowfax</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
