                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Training Manager/Executive</h4>
                                                                <p>Whitehat Education Technology Pvt. Ltd.</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Manager - Teacher Recruitment & Training - Online Coding Education (2-8 yrs)</h4>
                                                                <p>Assure Manapower Solutionss Pvt. Ltd.</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                ...
                                                                <p>SPEAKWELL ENTERPRISES PVT. LTD</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
