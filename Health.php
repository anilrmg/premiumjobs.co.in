                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>Paramedic Staff Pan India</h4>
                                                                <p>Quantum Corp Health Pvt Ltd</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                 <h4>Clinical Care Nurse</h4>
                                                                <p>Nightingales Home Health Specialist</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Mega Walk-in For Health Care Claim Process in MNC - Airolli</h4>
                                                                <p>2COMS Consulting Private Limited</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>BSc/GNM/ANM Nurses & Brothers for Arooj Home Health Care</h4>
                                                                <p>Arooj Healthcare Pvt. Ltd</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Business Head:Public Health</h4>
                                                                <p>CareNX Innovations</p>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Urgently required MBBS + AFIH Doctor</h4>
                                                                <p>Oshmedics Healthcare LLP</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
