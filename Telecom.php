                                        ...
                                        <div class="content">
                                            <div class="box">
                                                <p>
                                                    ...
                                                    <label for="c1">Design,Art&Multimedia<span>(214)</span></label>

                                                    <p>
                                                        <input type="checkbox" id="c2" name="cb">
                                                        <label for="c2">Education & Training<span>(514)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c3" name="cb">
                                                        <label for="c3">Accounting/Finance<span>(554)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c4" name="cb">
                                                        <label for="c4">Human Resource<span>(457)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c5" name="cb">
                                                        <label for="c5">Telecommunications<span>(1254)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c6" name="cb">
                                                        <label for="c6">Restaurant/Food Service<span>(554)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c7" name="cb">
                                                        <label for="c7">Construction/Facilities<span>(350)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c8" name="cb">
                                                        <label for="c8">Health<span>(221)</span></label>
                                                    </p>
                                                     <p>
                                                        <input type="checkbox" id="c8" name="cb">
                                                        <label for="c8">Technology<span>(250)</span></label>
                                                    </p>
                                                     <p>
                                                        <input type="checkbox" id="c8" name="cb">
                                                        <label for="c8">Developer<span>(250)</span></label>
                                                    </p>
                                                     <p>
                                                        <input type="checkbox" id="c8" name="cb">
                                                        <label for="c8">Bank<span>(260)</span></label>
                                                    </p>
                                            </div>
                                        </div>
                                        <ul>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img">
                                                                <a href="artgraphic.php"><img src="images/secton-img/tel1.png" alt="post_img" /></a>
                                                            </div>
                                                            <div class="jp_job_post_right_cont">
                                                              <h4>Assistant Manager - Telecom Network Operations and Maintenance - 13001 (1 - 3 Yrs Exp.)</h4>
                                                                <p>Tata Communications</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="jp_job_post_main_wrapper_cont jp_job_post_grid_main_wrapper_cont">
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="jp_job_post_side_img">
                                                                <a href="artgraphic.php"><img src="images/secton-img/tel2.png" alt="post_img" /></a>
                                                            </div>
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>11-Analyst-Telecom Operations</h4>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                  <h4>12-Associate-Telecom Operations (2-8 yrs)</h4>
                                                                <p>Accenture</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                               <h4>Jio Point Manager – Career in Telecom Jobs near me in Maharashtra</h4>
                                                                <p>Reliance JIO</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                              <h4>Telecom Engineer-Opensource Software</h4>
                                                                <p>Jampot Pvt. Ltd</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                 <h4>L3/IP-MPLS Testing Engineer</h4>
                                                                <p>ECI Telecom India Pvt Ltd</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont">
                                                                <h4>Telecom Engineer</h4>
                                                                <p>Ecolight Led Private Limited</p>
                                                                <ul>
                                                                    <li><i class="fa fa-inr" aria-hidden="true"></i>&nbsp; 1.8L–3.6L P.A.</li>
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Mumbai, Maharashtra, PO 200225</li>
                                                                </ul>
